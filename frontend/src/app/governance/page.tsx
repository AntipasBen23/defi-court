...
const mockProposals: Proposal[] = [
  {
    ...
    description:
      'Proposal to increase the minimum stake required for jurors from 100 DCT to 200 DCT to improve the quality of jurors.',
  ...
  },
  {
    ...
    description:
      'Reduce the voting period for disputes from 7 days to 5 days to speed up dispute resolution.',
...
export default function GovernancePage() {
  ...
  const getStatusColor = (
    status: string
  ): 'default' | 'success' | 'info' | 'danger' | 'outline' | 'warning' => {
    const statusMap = {
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-gray-400 mt-2">
              Participate in protocol governance and shape the future of DeFi
              Court
            </p>
          </div>
          <Button
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-6 text-sm">
                    ...
                    <span className="text-gray-400">
                      {timeAgo(proposal.createdAt.getTime())}
                    </span>
                  </div>
                ...
                {(['for', 'against'] as const).map((choice) => (
                  <label key={choice} className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setVoteChoice(e.target.value as 'for' | 'against')
                      }
                      className="mr-2"
                    />
                    <span
                      className={
                        choice === 'for' ? 'text-green-400' : 'text-red-400'
                      }
                    >
